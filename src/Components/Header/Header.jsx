...
class Header extends Component {
  ...
  showMode = () => {
    ...
    document.querySelector(".circle").style.left = "24px";
  ...
  render() {
    ...
    const { changeFonts, active, data, showFonts, hideFonts } = this.props;
    const allFonts = fonts.map((item) => {
      const { title, id } = item;
      return (
        <li
          key={id}
        ...
        <div className="head">
          ...
          <div className="dropdown">
            <div
              ...
              onClick={active == false ? showFonts : hideFonts}
            >
              {data}
              <ul className="block">{allFonts}</ul>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="13"
                height="9"
            ...
            <div
              className="mode"
              onClick={mode == false ? this.showMode : this.hideMode}
            >
